...
// Pass our map layers into our layers control and the layers control to the map.
L.control.layers(baseMaps).addTo(map);

// Accessing the airport GeoJSON URL
let airportData  = "https://raw.githubusercontent.com/gasconma1960/Mapping_Earthquakes/main/majorAirports.json";
...
L.geoJSON(data, {
  oneEachFeature: function(features, layer) {
    console.log(layer);
